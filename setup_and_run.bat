...
.venv\Scripts\pip install -r passive-shelter-thermal-platform\backend\requirements.txt
if %ERRORLEVEL% NEQ 0 (
...
.venv\Scripts\python passive-shelter-thermal-platform\scripts\verify_setup.py
